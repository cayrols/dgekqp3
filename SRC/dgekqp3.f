*> \brief \b DGEKQP3
*> This file is a modified dgeqp3 file where only k first columns are computed
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download DGEKQP3 + dependencies which are the same as dgeqp3
...
*  ===========
*
*       SUBROUTINE DGEKQP3( M, N, A, LDA, K, JPVT, TAU, WORK, LWORK, INFO )
* 
*       .. Scalar Arguments ..
*       INTEGER            INFO, LDA, LWORK, M, N, K
*       ..
*       .. Array Arguments ..
*       INTEGER            JPVT( * )
...
*> \verbatim
*>
*> DGEKQP3 computes a partial QR factorization with column pivoting of a
...
*> \verbatim
*>          K is INTEGER
*>          The number of columns of the matrix A to factorize.  K >= 0.
*> \endverbatim
*>
*> \param[in,out] JPVT
*> \verbatim
...
*>    S. Cayrols, INRIA Paris, ALPINES team
*>
*  =====================================================================
      SUBROUTINE DGEKQP3( M, N, A, LDA, K, JPVT, TAU, WORK,
     &            LWORK, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           DGEQRF, DLAKQP2, DLAQPS, DORMQR, DSWAP, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
