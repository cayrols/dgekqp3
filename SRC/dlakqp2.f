*> \brief \b DLAKQP2 computes a QR factorization with column pivoting of the matrix block.
* This file is modification of dlaqp2.f file made by Sebastien Cayrols
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE DLAKQP2( M, N, OFFSET, A, LDA, K, JPVT, TAU, VN1, VN2,
*                          WORK )
* 
*       .. Scalar Arguments ..
*       INTEGER            LDA, M, N, K, OFFSET
*       ..
*       .. Array Arguments ..
*       INTEGER            JPVT( * )
...
*> \verbatim
*>
*> DLAKQP2 computes a partial QR factorization with column pivoting of
